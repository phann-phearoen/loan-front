    ...
    <v-card-text>
      ...
      <div>
        <v-card-text class="normal">
          ...
          <br>
          ២- ភាគីសុំខ្ចីចងការៈ ឈ្មោះ ​{{loanTaker.name ? loanTaker.name : '.................'}} ភេទស្រី {{loanTaker.gender ? loanTaker.gender : '..............'}} អាយុ​ {{loanTaker.age ? loanTaker.age : '..............'}}​​ ឆ្នាំ អត្តសញ្ញាណបណ្ណលេខ
        ...
        ប្រាក់ខ្ចីចងការនះតាមចំនួន និងរាល់លក្ខខ័ណ្ឌដែលបានព្រមព្រៀងគ្នាដូចតទៅ​៖ <br>
          ...
          <p class="indent">
            ...
            <p class="indent">
            ខាងជើងទល់នឹង​ {{pawn.north ? pawn.north : '.......................'}}​ ខាងត្បូងទល់នឹង {{pawn.south ? pawn.south : '.......................'}}
            </p>
            <p class="indent">
            ខាងកើតទល់នឹង {{pawn.east ? pawn.east : '.......................'}} ខាងលិចទល់នឹង{{pawn.west ? pawn.west : '.......................'}}
            </p>
            <p class="indent">
